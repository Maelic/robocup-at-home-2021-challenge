...
if __name__ == '__main__':
  ...
  # Create Publishers
  objects_publisher = rospy.Publisher("/pcl_objects", PointCloud2, queue_size = 10)
  table_publisher = rospy.Publisher("/pcl_table", PointCloud2, queue_size = 10)
  clusters_publisher = rospy.Publisher("/pcl_cluster", PointCloud2, queue_size = 10)

  # Create Subscribers
  subscriber = rospy.Subscriber("/hsrb/head_rgbd_sensor/depth_registered/rectified_points", PointCloud2, pcl_callback)
